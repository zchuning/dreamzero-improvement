#!/bin/bash
# DreamZero Full Fine-Tuning with Return-Conditioned Behavior Cloning
#
# Computes Monte-Carlo returns (discounted sum of future rewards, globally
# normalized to [0,1]) and conditions the language prompt on the return:
#   "complete <task> with return 0.8"
#
# At inference time, condition on high return (e.g. 1.0) to generate
...
OUTPUT_DIR=${OUTPUT_DIR:-"/mnt/aws-lfs-02/shared/chuningz/checkpoints/dreamzero_ckpts/polaris_return_conditioned"}
...
REWARD_DISCOUNT=${REWARD_DISCOUNT:-0.99}
# =============================================
...
torchrun --nproc_per_node $NUM_GPUS --standalone groot/vla/experiment/experiment.py \
    ...
    +wandb_run_name=polaris_return_conditioned \
    ...
    reward_weighting_mode=return_conditioned \
