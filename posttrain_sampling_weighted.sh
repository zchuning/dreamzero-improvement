#!/bin/bash
# DreamZero Full Fine-Tuning with Sampling-Weighted Behavior Cloning
#
# Weights the data sampling probability by softmax(reward) across the dataset.
# Higher-reward frames are sampled more frequently during training.
#
# Prerequisites:
...
OUTPUT_DIR=${OUTPUT_DIR:-"/mnt/aws-lfs-02/shared/chuningz/checkpoints/dreamzero_ckpts/polaris_sampling_weighted"}
...
torchrun --nproc_per_node $NUM_GPUS --standalone groot/vla/experiment/experiment.py \
    ...
    +wandb_run_name=polaris_sampling_weighted \
    ...
    reward_weighting_mode=sampling_weighted \
